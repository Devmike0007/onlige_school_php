...
<body>
    <main>
        <div class="gauche">
            ...
            <div class="bottom">
                ...
                <div class="resaux">
                    ...
                    <a href="www.youtube.com"><img src="./img/Personnages/monenfant/icon/youtube.png" alt="facebook"></a>
                    <a href="www.instagram.com"><img src="./img/Personnages/monenfant/icon/instagram.png" alt="facebook"></a>
                </div>
            </div>
        </div>
        ...
        <div class="droite">
            <div class="logo">
                <img src="./img/fond_et_illustraction/illustration/Logo.png" alt="logo">
            </div>
            <div class="connexion">
                <h1>Connexion</h1>
                ...
                <form action="login.php" method="post">
                    ...
                    <div class="mot_de_passe_oublie">
                        <a href="http://localhost/onligne_school/admin/password.php"><img src="./img/Personnages/monenfant/icon/cadenas.png" alt="cadenas"><p>Mot de passe oublié ?</p></a>
                    </div>
                </form>
