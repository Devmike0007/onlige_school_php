        ...
        if (isset($_POST['modif_profil'])) {
            if (empty($_POST['prenom']) || !ctype_alpha($_POST['prenom'])) {
                ...
                if ($resultat) {
                    ...
                    $requete2 = $bdd->prepare('UPDATE onligne_schools.utilisateurs SET nom_utilisateur = :nom, prenom_utilisateur = :prenom, username = :username, photo_utilisateur = :photo_profil WHERE id_utilisateur = :id_utilisateur');
    ...
    <main>
        <div class="container">
            ...
            <div class="sibedar">
                ...
                <div class="ligne">
                    <a href="http://localhost/onligne_school/membre/profil.php"><i></i>Annuel</a>
